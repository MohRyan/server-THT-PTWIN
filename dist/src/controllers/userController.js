...
exports.updateUser = exports.deleteUser = exports.createUser = exports.getUser = exports.getUserWithToken = void 0;
const userService = __importStar(require("../services/userServices"));
const errorHandler_1 = require("../utils/errorHandler");
const getUserWithToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = res.locals.userId;
        const dataUser = yield userService.getUserWithToken(id);
